...
namespace AplikacioniSloj
{
    public class clsTerminServis
    {
        ...
        public bool Izmeni(int idTermina, DateOnly datum, TimeOnly vreme)
        {
            return _repo.IzmeniTermin(idTermina, datum, vreme);
        }

        public DataSet Prikazi(int idTermina)
        {
            return _repo.DajTerminPoID(idTermina);
        }
    }
}
